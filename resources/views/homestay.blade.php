                ...
                <div class="row">
                    <div class="col-lg-8 mt-4 mt-lg-0">
                        ...
                        <div class="section pt-5">
                            <h5>discription</h5>
                            <p class="mt-3"></p>
                        </div>Selamat datang di Martogi Homestay, oase tenang di tengah kota Balige yang ramah dan
                        hangat. Terletak strategis, kami menawarkan satu rumah utuh yang nyaman dan dilengkapi dengan
                        fasilitas lengkap untuk memenuhi kebutuhan Anda. Nikmati kenyamanan seperti di rumah sendiri
                        dengan suasana yang tenang dan pemandangan alam yang indah. Dengan akses mudah ke berbagai
                        atraksi lokal, Martogi Homestay adalah pilihan sempurna untuk wisatawan dan pelancong bisnis.
                        Raih momen berharga Anda di Balige dengan menginap bersama kami di Martogi Homestay!.
                        <div class="section pt-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p><strong class="color-black">Location:</strong> Huta Simangunsong, pantai, Lumban
                                        Bulbul, Kec. Balige, Sumatera Utara </p>
                        ...
                        <div class="section pt-4">
                            <h5>Features</h5>
                            <p class="mt-3">
                                Rumah Utuh yang Nyaman: Menyediakan satu rumah utuh dengan ruang tamu yang luas, kamar
                                tidur yang nyaman, dapur yang dilengkapi, dan kamar mandi bersih.
                                Lokasi Strategis: Terletak di pusat kota Balige, dengan akses mudah ke berbagai tempat
                                wisata dan fasilitas umum.
                                Pemandangan Indah: Nikmati pemandangan alam yang menakjubkan dari homestay, termasuk
                                pemandangan Danau Toba yang memukau.
                                Fasilitas Lengkap: Dilengkapi dengan fasilitas seperti AC, TV kabel, WiFi gratis, dan
                                parkir yang aman.
                                Kemudahan Berbelanja: Dekat dengan pasar tradisional dan toko-toko lokal untuk memenuhi
                                kebutuhan Anda selama menginap.
                                Pelayanan Ramah: Staf yang ramah dan siap membantu untuk memastikan pengalaman menginap
                                Anda menjadi yang terbaik..</p>
                        </div>
                    </div>
