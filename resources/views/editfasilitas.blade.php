    ...
    <div class="container">
        <form id="description-form" action="{{ route('update.fasilitas', $homestay->id) }}" method="POST" enctype="multipart/form-data" class="row justify-content-center padding-bottom-smaller">
            ...
            <div class="col-md-4 ajax-form">
                ...
                <input name="name" type="text" autocomplete="off" required value="{{ old('name', $homestay->name) }}" />
                @error('name')
            ...
            <div class="col-md-4 mt-5 mt-md-0 ajax-form">
                ...
                <input name="feature" type="text" autocomplete="off" required value="{{ old('feature', $homestay->features) }}" />
                @error('feature')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 ajax-form">
                ...
                <input name="roomsize" type="text" autocomplete="off" required value="{{ old('roomsize', $homestay->room_size) }}" />
                @error('roomsize')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 ajax-form">
                ...
                <select id="occupancy" name="occupancy" class="mt-3"> 
                    <option value="{{$homestay->occupancy}}">{{$homestay->occupancy}}</option>
            ...
            <div class="col-md-4 mt-5 mt-md-0 ajax-form">
                ...
                <input name="view" type="text" autocomplete="off" required value="{{ old('view', $homestay->view) }}" />
                @error('view')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 radio-input ">
                ...
                <div class="row text-center mt-3">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="" type="radio" name="smoking" id="smoking" value="Yes" >
                            <label class="form-check-label" for="smoking">
                              Yes
                            </label>
                        </div>
                    ...
                    <div class="col-md-6"> 
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="smoking" id="smoking" value="No" checked>
                            <label class="form-check-label" for="smoking">
                              No
                            </label>
                        </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 ajax-form">
                ...
                <input name="location" type="text" autocomplete="off" required value="{{ old('location', $homestay->location) }}" />
                @error('location')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 radio-input">
                ...
                <div class="row text-center mt-3">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="" type="radio" name="roomservice" id="roomservice" value="Yes" >
                            <label class="form-check-label" for="roomservice">
                              Yes
                            </label>
                        </div>
                    ...
                    <div class="col-md-6"> 
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="roomservice" id="roomservice" value="No" checked>
                            <label class="form-check-label" for="roomservice">
                              No
                            </label>
                        </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 radio-input">
                ...
                <div class="row text-center mt-3">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="" type="radio" name="swimmingpool" id="swimmingpool" value="Yes" >
                            <label class="form-check-label" for="swimmingpool">
                              Yes
                            </label>
                        </div>
                    ...
                    <div class="col-md-6"> 
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="swimmingpool" id="swimmingpool" value="No" checked>
                            <label class="form-check-label" for="swimmingpool">
                              No
                            </label>
                        </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0 ajax-form">
                ...
                <input name="price" type="number" autocomplete="off" required value="{{ old('price', $homestay->price) }}" />
                @error('price')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
